<?php
/**********************************************************************************
* InlineAttachmentsAdmin.dutch.php - Dutch language file, translated by @rjen
***********************************************************************************
...
$txt['ila_admin_settings'] = 'Inline Bijlagen';
$txt['ila_new_version'] = 'Post en PB Inline Bijlagen mod versie %s is beschikbaar voor download!';
$txt['ila_no_update'] = 'Je installatie  van Post en PB Inline Bijlagen is up to date!';
$txt['ila_completed_singular'] = '1 bericht met inline bijlagen is bijgewerkt!';
$txt['ila_completed_plural'] = '%d berichten met inline bijlagen zijn bijgewerkt!';

$txt['ila_title'] = 'Post en PB Inline Bijlagen';
$txt['ila_insert_tag'] = 'Tag om te gebruiken bij invoegen van inline bijlagen:';
$txt['ila_attach_same_as_attachment'] = '&quot;attach&quot; bbcode gelijk maken aan &quot;attachment&quot;?';
$txt['ila_insert_format'] = 'Formaat voor invoegen van bijlagen tags:';

$txt['ila_max_width'] = 'Beperk afbeeldingen tot een maximum breedte van:<div class="smalltext">LET OP: <strong>0</strong> = uitgeschakeld</div>';
$txt['ila_max_height'] = 'Beperk afbeeldingen tot een maximum hoogte van:<div class="smalltext">LET OP: <strong>0</strong> = uitgeschakeld</div>';
$txt['ila_enable_responsive'] = 'Activeer responsive CSS voor inline bijlagen?';

$txt['ila_highslide'] = 'Activeer Highslide effecten voor inline bijlagen?';
$txt['ila_one_based_numbering'] = 'Eerste bijlage nummeren met &quot;1&quot;?';
$txt['ila_one_based_numbering_ask'] = 'Alle inline bijlage IDs aanpassen zodat deze weer werken als voorheen?  Druk op \"OK\" om dit toe te passen bij opslaan.';
$txt['ila_allow_quoted_images'] = 'Toestaan om bijlagen op te nemen in citaten?';
$txt['ila_duplicate'] = 'Verwijder de weergave van bijlagen onder het bericht als deze in het bericht wordt opgenomen?';
$txt['ila_download_count'] = 'Download link en telling weergeven:';
/* 0 */ $txt['ila_download_count_n'] = 'Uitgeschakeld';
/* 1 */ $txt['ila_download_count_f'] = 'Alleen bestandsnaam';
/* 2 */ $txt['ila_download_count_fs'] = 'Bestandsnaam en grootte';
/* 3 */ $txt['ila_download_count_fsd'] = 'Bestandsnaam, grootte, en afmetingen';
/* 4 */ $txt['ila_download_count_fsdc'] = 'Bestandsnaam, grootte, afmetingen en teller';
/* 5 */ $txt['ila_download_count_fsdc2'] = 'Bestandsnaam, grootte, afmetingen en teller (2 regels)';
/* 6 */ $txt['ila_download_count_fsdc3'] = 'Bestandsnaam, grootte, afmetingen en teller (3 regels)';
/* 7 */ $txt['ila_download_count_fsd2'] = 'Bestandsnaam, grootte en afmetingen (2 regels)';
$txt['ila_transparent'] = 'Niet goedgekeurde afbeeldingen transparant tonen: (%)<div class="smalltext">LET OP: <strong>0</strong> deactiveert het tonen van niet goedgekeurde afbeeldingen</div>';

$txt['ila_embed_video_files'] = 'Ondersteunde video formaten insluiten in het bericht?';
$txt['ila_video_default_width'] = 'Standaard breedte van video als deze niet wordt opgegeven:';
$txt['ila_video_default_height'] = 'Standaard hoogte van video als deze niet wordt opgegeven:';
$txt['ila_video_show_download_link'] = 'Toon een download link voor videos?';
$txt['ila_video_html5'] = 'Gebruik HTML5 video tags voor het tonen van video:';

$txt['ila_embed_svg_files'] = 'SVG bestanden insluiten in het bericht?';
$txt['ila_embed_pdf_files'] = 'PDF bestanden insluiten in het bericht?';
$txt['ila_embed_txt_files'] = 'TXT bestanden insluiten in het bericht?';
$txt['ila_disable_strip_html_in_txt'] = 'HTML tags handhaven in TXT bestanden?<div class="smalltext">LETOP: Dit kan een veiligheids risico zijn!</div>';

$txt['ila_turn_nosniff_off'] = 'Schakel de &quot;nosniff&quot; optie voor IE 8+ uit?';
$txt['ila_display_exif'] = 'Toon EXIF informatie onder de afbeelding?';
