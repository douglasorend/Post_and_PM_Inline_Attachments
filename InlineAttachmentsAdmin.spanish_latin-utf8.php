...
$txt['ila_insert_tag'] = 'Etiquetas a utilizar al insertar archivos adjuntos en línea:';
...
$txt['ila_one_based_numbering_ask'] = '¿Desea ajustar todas las ID de los archivos adjuntos en línea para que sigan funcionando igual que antes? Presione &quot;OK&quot; para hacer esto al guardar.';
$txt['ila_enable_responsive'] = '¿Habilitar el CSS responsivo para archivos adjuntos en línea?';
...
$txt['ila_popup_help'] = '¿Incluir enlace para los parámetros de la ventana emergente ILA?';
...
$helptxt['ila_highslide'] = 'Cuando está activada, esta opción utiliza uno de los mods compatibles para visualizar la imagen utilizando <a href="http://www.highslide.com/">High slide</a> efectos.<br /><br />Los siguientes mods son compatibles:
	<blockquote class="bbc_standard_quote">
		...
		<strong><a href="http://custom.simplemachines.org/mods/index.php?mod=1450">Visor de imágenes alta resolución</a></strong><br />
...
$helptxt['ila_embed_video_files'] = 'Cuando se activa, esta opción le permite incluir los siguientes archivos de vídeo en un puesto:
	<blockquote class="bbc_standard_quote">
		<strong>AVI</strong> - Reproducir usando <strong><a href="http://www.divx.com">DivX</a></strong>\'s player. Supone que el códec DivX está instalado en el sistema operativo que se está explorando.<br />
...
$helptxt['ila_embed_txt_files'] = 'Cuando está marcada, esta opción le permite incrustar el contenido de un archivo TXT en la publicación.<br /><br />El valor predeterminado es <strong>desactivado</strong>.';
$helptxt['ila_embed_pdf_files'] = 'Cuando está marcada, esta opción le permite incrustar un archivo PDF adjunto en la publicación mediante el servicio Google Docs. Tenga en cuenta que Google Docs no puede extraer el archivo adjunto de las direcciones <strong>localhost</strong> y <strong>127.0.0.1</strong>, ni direcciones IP sin resolver (más notablemente las IP de red detrás de un router(enrutador), por ejemplo: <strong>192.168.1.1</strong>).<br /><br />El valor predeterminado es<strong>desactivado</strong>.';
$helptxt['ila_turn_nosniff_off'] = 'Al activar esta opción puede ayudar a resolver cuestiones en las que el tipo MIME de un archivo adjunto no coincide con el tipo real de los datos adjuntos y los usuarios están utilizando IE8+.<br /><br />
	<strong>¿Qué hace la opción &quot;nosniff&quot; en IE 8+?:</strong>
	<blockquote class="bbc_standard_quote">
...
$helptxt['ila_enable_responsive'] = 'Al marcar esta opción, redimensiona dinámicamente las imágenes para que permanezcan dentro del área de publicaciones del foro, independientemente del tamaño de la ventana. No tener esta opción activada y no tener un ancho/alto específico definido dará como resultado imágenes que se extiendan sobre el área de publicación y resultará en la necesidad de usar las barras de desplazamiento para ver la imagen completa.';
